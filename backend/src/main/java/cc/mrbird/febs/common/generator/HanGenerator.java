...
public class HanGenerator {
    // 数据库 URL
    private static final String URL = "jdbc:mysql://127.0.0.1:3306/febs_rczp?useUnicode=true&characterEncoding=UTF-8&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC";
    // 数据库驱动
    ...
    private static final String PageUrl = "D:/java/rczp/febs-rczp/frontend/src/views/";
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"zp_staff_info"}); // 需要生成的表
